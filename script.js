(function () {
  ...
  const POIS = [
    ...
    },
    {
      ...
      color: '#157347',
      x: 50.0, y: 68.5,
      title: 'Lower Lake Boardwalk',
      eyebrow: 'Leisure · Lakeside',
      body: 'The lower lake features a timber boardwalk with lily-pad viewing spots and a small jetty ideal for photography, relaxation, and paddle boat hire.',
      pills: [
        '🚣 Paddle boat hire available',
        '🎣 Fishing permitted (licence required)',
    ...
    },
    {
      ...
      color: '#235aa8',
      x: 57.5, y: 59.5,
      title: 'Wayfinding Sign – Central South',
      eyebrow: 'Access · Wayfinding',
      body: 'Directional signage at the southern junction, guiding visitors toward the lower lake boardwalk, return paths, and the food pop-up zone.',
      pills: [
        '🗺️ Directions to all key areas',
    ...
    },
    {
      ...
      color: '#235aa8',
      x: 8.0, y: 70.0,
      title: 'Wayfinding Sign – South Entry',
      eyebrow: 'Access · Wayfinding',
      body: 'Entry-point signage at the southern boundary providing park orientation and estimated walking times to main attractions.',
      pills: [
        '🗺️ Park overview map displayed',
        '⏱️ Estimated walking times shown',
        '🚑 First aid point nearby',
      ],
      artColor: '#1a4a8a',
    },
    {
      ...
      color: '#157347',
      x: 14.5, y: 39.5,
      title: 'Upper Lake Walkway',
      eyebrow: 'Leisure · Walking Trail',
      body: 'A paved lakeside path that circles the upper lake, offering shaded routes, rest benches, and beautiful views across the water.',
      pills: [
        '🔄 1.2 km full loop',
        '♿ Pram & wheelchair friendly',
        '🌅 Open sunrise to sunset',
        '🦆 Wildlife viewing spots along route',
      ],
      artColor: '#0d5233',
    },
  ];
